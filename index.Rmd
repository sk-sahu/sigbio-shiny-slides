---
title: "SigBio-Shiny"
subtitle: "A standalone interactive application for detecting biological significance on a Gene-Set"
...
- What is detecting Biological Significance on a Gene-Set means?
- Some of available resources
- Ideal scenarios for a gene-set based analysis
...
# Biological Significance on a Gene-Set
...
SigBio-Shiy provides a standalone R-Shiny based GUI application for doing such geneset based analysis. Build on top of already available open-source infrastructure, Such as - 
...
Build on a modular approach such that adding a new package/functionality is easy for a contributors. 
